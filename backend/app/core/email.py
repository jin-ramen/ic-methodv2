...
def _fmt_dt(dt: datetime | None) -> str:
    ...
    return dt.strftime(f"{day} %B %Y · %H:%M")
...
async def send_booking_confirmation_email(
    *,
    ...
    start_txt = _fmt_dt(session_start)
    end_txt = _fmt_dt(session_end)
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" class="email-card" style="max-width:540px;background-color:rgba(107,67,46,0.85);border-radius:16px;overflow:hidden;">
          ...
          <tr>
            <td style="padding:36px 40px 0;">
              ...
              <h1 style="margin:0 0 24px;font-family:'Cormorant Garamond',Georgia,'Times New Roman',serif;font-size:30px;font-weight:300;line-height:1.25;color:#FFEDE8;">Your commitment<br>is confirmed.</h1>
