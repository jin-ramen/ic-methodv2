...
export default function CancelBookingModal({ commitmentId, clientName, onClose, onDeleted }: Props) {
    ...
    const matches = input.trim() === clientName;
    ...
    return (
        <div className="lg:bg-black/40 fixed inset-0 z-50 flex items-center justify-center">
            ...
            >
                <p className="font-cormorant text-wood-text text-xl tracking-wide mb-2">Cancel Booking</p>
                <p className="font-didot text-xs text-wood-text/50 mb-6 leading-relaxed">
                    Type <span className="text-wood-text/80 italic">{clientName}</span> to confirm removal.
                </p>
