  ...
  return (
    ...
    <div className="flex-1 flex items-center justify-center">
      <div className="w-[70vw] md:w-[45vw] lg:w-[30vw] flex flex-col items-center gap-8">
        ...
        <Link
          to="/booking"
          className=" opacity-0 animate-text-in [animation-delay:200ms] inline-flex items-center gap-3 font-didot text-xs tracking-[0.2em] uppercase bg-wood-accent/90 text-wood-text hover:bg-wood-dark transition-colors duration-300 py-3 px-8 rounded-md group"
        >
          <>
