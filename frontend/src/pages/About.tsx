  ...
  return (
    <div className="flex-1 flex items-center justify-center">
      ...
      <div className="w-[45vw] md:w-[30vw] lg:w-[20vw] flex flex-col items-center gap-8">
        ...
        <Link
          to="/booking"
          className={`md:hidden opacity-0 animate-text-intro inline-flex items-center gap-3 font-didot text-xs tracking-[0.2em] uppercase bg-wood-accent text-wood-text hover:bg-wood-dark transition-colors duration-300 py-3 px-8 rounded-xs group ${shouldAnimate ? '[animation-delay:6000ms]' : '[animation-delay:200ms]'}`}
        >
          <span>Book</span>
