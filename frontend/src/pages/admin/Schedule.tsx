...
export default function Schedule() {
    ...
    return (
        ...
        >
            <div className="flex-1 min-h-0 flex flex-col px-6 py-6 md:px-10 md:py-5 overflow-hidden rounded-xl bg-wood-dark/5">
                ...
                <div className="hidden lg:flex flex-col flex-1 overflow-hidden">
                    <div className="flex justify-between mb-6 shrink-0">
                        ...
                        <button
                            onClick={() => setOffset(Math.min(MAX_DAYS - 4, offset + 5))}
